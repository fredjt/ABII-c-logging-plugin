...
#ifndef ABII_C_LOGGING_PLUGIN_UNISTD_64_H
#define ABII_C_LOGGING_PLUGIN_UNISTD_64_H

#include <abii/libabii.h>

namespace abii
{
const defines_map unistd_64_syscall_no = {
    {0, "__NR_read"},
    {1, "__NR_write"},
    {2, "__NR_open"},
    {3, "__NR_close"},
    ...
    {331, "__NR_pkey_free"},
    {332, "__NR_statx"},
    {333, "__NR_io_pgetevents"},
    {334, "__NR_rseq"},
    {335, "__NR_uretprobe"},
    {424, "__NR_pidfd_send_signal"},
    ...
    {434, "__NR_pidfd_open"},
    {435, "__NR_clone3"},
    {436, "__NR_close_range"},
    {437, "__NR_openat2"},
    {438, "__NR_pidfd_getfd"},
    {439, "__NR_faccessat2"},
    {440, "__NR_process_madvise"},
    {441, "__NR_epoll_pwait2"},
    {442, "__NR_mount_setattr"},
    {443, "__NR_quotactl_fd"},
    {444, "__NR_landlock_create_ruleset"},
    {445, "__NR_landlock_add_rule"},
    {446, "__NR_landlock_restrict_self"},
    {447, "__NR_memfd_secret"},
    {448, "__NR_process_mrelease"},
    {449, "__NR_futex_waitv"},
    {450, "__NR_set_mempolicy_home_node"},
    {451, "__NR_cachestat"},
    {452, "__NR_fchmodat2"},
    {453, "__NR_map_shadow_stack"},
    {454, "__NR_futex_wake"},
    {455, "__NR_futex_wait"},
    {456, "__NR_futex_requeue"},
    {457, "__NR_statmount"},
    {458, "__NR_listmount"},
    {459, "__NR_lsm_get_self_attr"},
    {460, "__NR_lsm_set_self_attr"},
    {461, "__NR_lsm_list_modules"},
    {462, "__NR_mseal"},
    {463, "__NR_setxattrat"},
    {464, "__NR_getxattrat"},
    {465, "__NR_listxattrat"},
    {466, "__NR_removexattrat"},
    {467, "__NR_open_tree_attr"},
    {468, "__NR_file_getattr"},
    {469, "__NR_file_setattr"}
};

template <typename T>
std::string print_unistd_64_syscall_no(const T v)
{
    return print_enum_entry(v, unistd_64_syscall_no);
}
}

#endif //ABII_C_LOGGING_PLUGIN_UNISTD_64_H

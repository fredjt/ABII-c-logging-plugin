...
namespace abii
{
static __attribute__ ((__format__ (__printf__, 1, 2))) void (*real_warn)(const char*, ...) = nullptr;
...
static __attribute__ ((__format__ (__printf__, 1, 0))) void (*real_vwarn)(const char*, __gnuc_va_list) = nullptr;
...
static __attribute__ ((__format__ (__printf__, 1, 2))) void (*real_warnx)(const char*, ...) = nullptr;
...
static __attribute__ ((__format__ (__printf__, 1, 0))) void (*real_vwarnx)(const char*, __gnuc_va_list) = nullptr;
...
static __attribute__ ((__noreturn__, __format__ (__printf__, 2, 3))) void (*real_err)(int, const char*, ...) = nullptr;
...
static __attribute__ ((__noreturn__, __format__ (__printf__, 2, 0)))
void (*real_verr)(int, const char*, __gnuc_va_list) = nullptr;
...
static __attribute__ ((__noreturn__, __format__ (__printf__, 2, 3))) void (*real_errx)(int, const char*, ...) = nullptr;
...
static __attribute__ ((__noreturn__, __format__ (__printf__, 2, 0)))
void (*real_verrx)(int, const char*, __gnuc_va_list) = nullptr;

...
static __nonnull((1)) char** (*real_backtrace_symbols)(void* const*, int) __THROW = nullptr;
...
static __nonnull((1)) void (*real_backtrace_symbols_fd)(void* const*, int, int) __THROW = nullptr;

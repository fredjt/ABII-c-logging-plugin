...
namespace abii
{
static ssize_t (*real_strfmon)(char*, size_t, const char*, ...) noexcept(true) = nullptr;
...
static ssize_t (*real_strfmon_l)(char*, size_t, locale_t, const char*, ...) noexcept(true) = nullptr;

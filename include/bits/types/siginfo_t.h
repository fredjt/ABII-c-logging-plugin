...
std::ostream& operator<<(std::ostream& os, T&& obj)
{
    ...
    auto printer = ArgPrinter(obj.si_signo, "si_signo", &os);
    printer.set_enum_printer(print_signum_enum_entry, obj.si_signo);
    abii_args->push_arg(&printer);

    auto printer1 = ArgPrinter(obj.si_errno, "si_errno", &os);
    printer1.set_enum_printer(print_error_enum_entry, obj.si_errno);

    auto printer2 = ArgPrinter(obj.si_code, "si_code", &os);
    switch (obj.si_signo)
    {
    case SIGILL:
...
std::ostream& operator<<(std::ostream& os, T&& obj)
{
    ...
    auto printer = ArgPrinter(obj.si_status, "si_status", &os);
...
std::ostream& operator<<(std::ostream& os, T&& obj)
{
    ...
    auto printer = ArgPrinter(obj._arch, "_arch", &os, RECURSE);
